...
/**
 * <p> Built in job for executing native executables in a separate process.
 * 《在独立的进程中执行本地可执行文件的内建job》
 * </p> 
 * 
 * <pre>
 ...
 * 《如果PROP_WAIT_FOR_PROCESS为true,那么进程退出整数值将作为job执行的结果保存到JobExecutionContext中》
 * 
 * @see #PROP_COMMAND
 * @see #PROP_PARAMETERS
