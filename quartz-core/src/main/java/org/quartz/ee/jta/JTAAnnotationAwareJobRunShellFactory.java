 ...
 * <--负责创建JobRunShell实例以用于QuartzScheduler实例。它将创建一个标准的JobRunShell，
 * 除非job类有ExecuteInJTATransaction的注解时它才创建JTAJobRunShell-->
 * </p>
 * 
 * <p>
 ...
 * <--这个实现没有重利用任何对象，每次borrowJobRunShell()方法调用，它都简单的创建一个JTAJobRunShell实例-->
 * </p>
 * 
 * @author James House
 */
