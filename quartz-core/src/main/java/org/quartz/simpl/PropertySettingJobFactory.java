 ...
 * <--一个实例化Job对象（使用无参构造函数，更多细节看class.newInstance()）的JobFactory，
 * 尝试的从SchedulerContext和JobExecutionContext合并的JobDataMap中设置所有Job属性值-->
 * 
 ...
 * JobDataMap.
 * <--在JobDataMap没有映射属性到你的Job类时，如果你想要繁杂的日志记录，设置'如果属性未发现警告'的属性为true。
 * 这对于属性名的排错可能是很有用的，等等。但这是非常繁杂的，如果你定期（故意的）的需要你的JobDataMap的详细数据-->
 * </p>
 * 
 ...
 * <--也可能对未找到属性时抛出无法匹配JobDataMap的Key的异常感兴趣-->
 * </p>
 * 
 * 
