 ...
 * jobs/triggers. 
 * 《基类的插件希望UserTransaction运行时支持start和shutdown方法。如果使用JobStoreCMT和插件对jobs/triggers影响，这是非常有必要的》
 * 
 * <p>
 ...
 * 《这个子类应该实现start和shutdown两个方法。如果wrapInUserTransaction属性为true，那么UserTransaction应该非null》
 * </p>
 * <p>
 ...
 * 《为了方便起见，这个基类也提供了一个initialize()的实现，保存了调度器和插件的名称，同时通过getLog()获取日志处理》
 * </p>
 */
